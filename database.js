...
//SELECT * FROM літак_пасажир WHERE Контактний_номер_телефону =? AND Назва_авіакомпанії =?
//SELECT  * FROM квиток_пасажир WHERE Країна_розташування =? AND Назва_аеропорту =?
//SELECT  * FROM екіпаж_пасажир WHERE Довжина <? AND Країна_прибуття =?
//SELECT  * FROM аеропорт_пасажир WHERE Стать =? AND Країна =?
//SELECT  * FROM тарифи_на_перевезення_тварин_пасажир WHERE Час_в_шляху =? AND Дата_вильоту =?
//SELECT  * FROM тарифи_для_пасажирів_пасажир WHERE Дата_продажу =? AND Рейс =?
//SELECT  * FROM авіатермінали_пасажир WHERE Марка_літака =? AND Авіакомпанія_власник =?
////////////////////////////
///Запити Анна
//
//
